...
**中文说明（主 README）：** [`README.md`](README.md)
...
| Doc | Description |
|-----|-------------|
| [`README.md`](README.md) | **中文总览**（GitHub 首页） |
...
```text
arm-param-identification/          # Project root
│
├── README.md                      # Chinese overview (GitHub homepage)
...
│   └── zh/                        # Chinese docs (METHOD, LEARNING, …)
│
